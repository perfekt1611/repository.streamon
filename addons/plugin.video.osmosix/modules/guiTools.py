...
def addItem(label, mode, icon):
    ...
    u = "plugin://plugin.video.osmosix/?url=" + "&mode=" + str(mode) + "&fanart=" + urllib.quote_plus(icon)
...
def addFunction(labels):
    utils.addon_log('addItem')
    u = "plugin://plugin.video.osmosix/?url=" + "&mode=" + str(666) + "&fanart=" + urllib.quote_plus(updateIcon)
